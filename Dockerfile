...
LABEL onlyoffice.mailserver.release-date="${RELEASE_DATE}" \
      ...
      description="Mail Server is an Ektai mail server solution that allows connecting your own domain name to EKTAI collaboration platform,as well as creating and managing corporate mailboxes."
      maintainer="Ektai Solution Pty Ltd <support@ekt.ai>" \
      securitytxt="https://www.ekt.ai/.well-known/security.txt"
